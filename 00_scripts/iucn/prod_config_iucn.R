...
popDeclinefile  <- "00_data/populationdeclines.csv"
...
extremefluctationsfile <- "01_analyses_full/results/extremefluctuations.csv"
...
criteriaCResultsfile <- "01_analyses_full/results/criteriaC_results.csv"
