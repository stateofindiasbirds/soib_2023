...
base = read.csv("fullspecieslist_mask_cropland.csv")
...
file_names = dir("trends_mask_cropland") #where you have your files
trends = do.call(rbind,lapply(paste("trends_mask_cropland/",file_names,sep=""),read.csv))
...
write.csv(sens,"trends_results/full_results/mask_cropland.csv",row.names=F)
...
write.csv(trends,"trends_results/mask_cropland/trends_mask_cropland.csv",row.names=F)
...
write.csv(main,"trends_results/mask_cropland/SoIB_main_mask_cropland_wocats.csv",row.names=F)
...
main = read.csv("trends_results/mask_cropland/SoIB_main_wocats.csv")
...
sens = read.csv("trends_results/mask_cropland/current_sensitivity.csv")
...
write.csv(main,"trends_results/mask_cropland/SoIB_main_mask_cropland.csv",row.names=F)
...
write.csv(summary_status,"trends_results/mask_cropland/summary_status_mask_cropland.csv",row.names=F)
write.csv(priority_summary,"trends_results/mask_cropland/priority_status_mask_cropland.csv",row.names=F)
write.csv(species_summary,"trends_results/mask_cropland/species_status_mask_cropland.csv",row.names=F)
