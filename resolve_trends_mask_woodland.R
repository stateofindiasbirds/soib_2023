...
write.csv(trends,"trends_mask_woodland.csv",row.names=F)
...
write.csv(main,"SoIB_main_mask_woodland.csv",row.names=F)
...
write.csv(summary_status,"summary_status_mask_woodland.csv",row.names=F)
write.csv(priority_summary,"priority_status_mask_woodland.csv",row.names=F)
write.csv(species_summary,"species_status_mask_woodland.csv",row.names=F)