...
write.csv(sens,"trends_results/mask_woodland/current_sensitivity.csv",row.names=F)
...
main = read.csv("trends_results/mask_woodland/SoIB_main_wocats.csv")
...
sens = read.csv("trends_results/mask_woodland/current_sensitivity.csv")
