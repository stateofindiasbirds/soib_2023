...
specieslist1 = specieslist %>% filter(COMMON.NAME %in% c("Asian Openbill","Oriental Darter","Whiskered Tern",
                                                         "Woolly-necked Stork","Eurasian Marsh-Harrier","Brahminy Kite",
                                                        "Cinnamon Bittern","Black Bittern","Yellow Bittern",
                                                        "Bronze-winged Jacana","Cotton Pygmy-Goose","Black-crowned Night-Heron",
                                                        "Glossy Ibis","Pacific Golden-Plover","Black-headed Ibis",
                                                         "Common Greenshank","Gray-headed Swamphen"))
c = 0
...
write.csv(trends, "assorted_trends_4.csv", row.names = F)
# at assorted 3
