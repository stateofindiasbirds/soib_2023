...
## remove species based on 1 extra metric (no 5km filters here)
...
write.csv(trends,"trends_mask_pa.csv",row.names=F)
...
write.csv(main,"SoIB_main_mask_pa.csv",row.names=F)
...
write.csv(summary_status,"summary_status_mask_pa.csv",row.names=F)
write.csv(priority_summary,"priority_status_mask_pa.csv",row.names=F)
write.csv(species_summary,"species_status_mask_pa.csv",row.names=F)